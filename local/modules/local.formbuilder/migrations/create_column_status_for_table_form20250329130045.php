...
class create_column_status_for_table_form20250329130045 extends Version
{
    protected $description = "121104 | Реализация конструктора форм заявки на услуги | Создание столбца \"Статус\" для таблицы \"Форма\"";
